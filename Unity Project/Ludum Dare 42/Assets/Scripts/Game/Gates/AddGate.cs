...
{
	public AddGate( CellCoordinates _coordinates, ObjectOrientation _orientation )
		: base( FindFootprint( _coordinates, _orientation ), FindInputs( _coordinates, _orientation ), FindOutputs( _coordinates, _orientation ), GateType.Add )
	{
	}
	...
	public override void DoOperation( int[] _inputs, bool[] _readyInputs, int numReadyInputs )
	{
		...
		{
			Debug.LogError( "AddGate: Expected 2 inputs got " + numReadyInputs );
		}
